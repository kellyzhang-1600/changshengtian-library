...
create table public.texts (
  ...
  translation_note_zh text,
  translation_note_en text,
  translation_note_mn text,
  today_line_mn text,
  today_line_zh text,
  today_line_en text,
  people text[] default '{}',
  places text[] default '{}',
  themes text[] default '{}',
  themes_en text[] default '{}',
  themes_mn text[] default '{}',
  latitude numeric,
  longitude numeric,
  region_name text,
...
create table public.books (
  ...
  slug text unique not null,
  title text not null,
  localized_metadata jsonb not null default '{}'::jsonb,
  cover_url text,
  pdf_url text,
  published_at text,
  publisher text,
